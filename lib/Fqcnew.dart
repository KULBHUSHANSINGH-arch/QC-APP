...
class FqcNewPage extends StatefulWidget {
  FqcNewPage({Key? key}) : super(key: key);

  @override
  _FqcNewPageState createState() => _FqcNewPageState();
}

class _FqcNewPageState extends State<FqcNewPage> {
  String? firstname,
      designation,
      department,
      lastname,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                    child: tabDashboard('FQC Check', AppAssets.qualityadd, () {
                  Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
